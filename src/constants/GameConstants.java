...
public class GameConstants {
    ...
    private static final int[]  EXP_RATE_GAIN = {1, 1, 1, 1, 1, 1, 1, 1, 1, 89, 144, 233, 377, 610};    //fibonacci :3
    ...
    public static int[] getCustomKey(boolean customKeyset) {
        return(customKeyset ? DEFAULT_KEY : DEFAULT_KEY);
    }
    
    public static int[] getCustomType(boolean customKeyset) {
        return(customKeyset ? DEFAULT_TYPE : DEFAULT_TYPE);
    }
    
    public static int[] getCustomAction(boolean customKeyset) {
        return(customKeyset ? DEFAULT_ACTION : DEFAULT_ACTION);
    }
